      ...
      <Layout hasLoadingObj={false}>
        <div className="page-wrapper notes">
          ...
          <div className="scroll-container">
            <MainVisual>
              <PageHeader titleImage="title-notes" titleClass={"notes"} subTitle={`制作の過程でお客様ご自身に準備して頂きたいものや、\nご依頼前に事前にご確認頂きたい注意事項をまとめます`} alt="事前確認事項" />
            </MainVisual>
              ...
              <div className="content__block">
                ...
                <div className="list-wrap">
                  <ul className="hearing-list">
                    ...
                    <li className="list-item">画像データ・テキストデータの有無</li>
                    <li className="list-item">
                      サーバー・ドメインの有無
                      <br className="only-tab" />
                ...
                <div className="lead-text">すべての項目は下記よりご確認できます。</div>
                <a href="https://docs.google.com/forms/d/1AUwiErMWtScRxn9sW9tx1u58z2wfGXCblTflSJIrD-U/edit" className="external-link google-forms" target="_blank" rel="noopener noreferrer">
                  ヒアリングシート
                </a>
              </div>
              <div className="content__block">
                ...
                <div className="flex-block align-center">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>
                      上記の
                      <a href="https://docs.google.com/forms/d/1AUwiErMWtScRxn9sW9tx1u58z2wfGXCblTflSJIrD-U/edit" target="_blank" rel="noopener noreferrer">
                        ヒアリングシート
                      </a>
                ...
                <div className="flex-block align-center">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>作業全体の工数を試算し、それを基に正式なお見積りを作成します。</p>
                  </div>
                </div>
                <div className="flex-block align-center">
                  <div className="flex-item flow-number three-column">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>お見積りの内容にご納得頂いた後、本契約となります。契約時には「請負基本契約書」を締結させて頂きます</p>
                  </div>
                </div>
                <div className="flex-block align-center">
                ...
                <div className="flex-block align-center">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>ヒアリング内容を基に、サイト全体の構造を示したサイトマップの作成、ページごとのレイアウト設計を示したワイヤーフレーム作成と順に進めていきます。（テキスト原稿の準備が整っていない場合はワイヤーを基にお客様の方で内容をご考案頂きます。）</p>
                  </div>
                </div>
                <div className="flex-block align-center">
                  <div className="flex-item flow-number three-column">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>ワイヤーフレームを基に、各ページのデザインを作りこんでいきます。まずはTOPページをしっかりと作りこみ、全体の雰囲気や世界観を構築します。お客様との合意が得られた段階で、残りの下層ページについてはＴＯＰページを基に一気に作りこんでいきます。</p>
                  </div>
                </div>
                <div className="flex-block align-center">
                  <div className="flex-item flow-number three-column">
                ...
                <div className="flex-block align-center">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>サイト全体が完成した後に私とお客様の方で最終チェックを行います。チェック方法としては、私が持つテスト用のサーバーにサイト一式をアップロードして、そのＵＲＬにお客様の方でアクセス頂きご確認いただきます。</p>
                  </div>
                </div>
                <div className="flex-block align-center">
                  <div className="flex-item flow-number three-column">
                  ...
                  <div className="flex-item nine-column">
                    ...
                    <p>修正を終え、問題がないことが確認出来たら、本番用のサーバーにアップロードし晴れてWebサイトのリリースとなります。</p>
                  </div>
                </div>
              </div>
              <div className="content__block">
                ...
                <div className="list-wrap">
                  <ul className="cautions-list">
                    <li className="list-item">ドメイン・サーバーの契約および管理代行は行っていおりません。もし、契約方法が分からない場合はご相談ください。</li>
                    <li className="list-item">また、完成したサイトのその後の運用(ブログ記事を更新する等々）などもこちらでは対応できませんので。あらかじめご了承ください。</li>
                    <li className="list-item">完成したサイトは私自身の「制作実績」として、公開することを前提とした契約とさせて頂きます。もし、事情がありどうしても掲載したくないという場合は契約時にその旨をお伝えください</li>
                  </ul>
                </div>
              </div>
            </Content>
...
export const Head = (props) => {
  ...
  return (
    <>
      <Seo pageTitle={"事前確認事項"} pageDesc={"制作の過程でお客様ご自身に準備して頂きたいものや、\nご依頼前に事前にご確認頂きたい注意事項をまとめます"} pagePath={`/notes/`} pageImg={data.notes.childImageSharp.original.src} />
    </>
  );
};
